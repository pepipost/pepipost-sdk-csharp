...
{
    public partial class SubaccountsCreateSubaccountController: BaseController
    {
        ...
        /// </summary>
        internal static SubaccountsCreateSubaccountController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// </summary>
        /// <param name="body">Required parameter: create sub account</param>
        /// <return>Returns the object response from the API call</return>
        public object CreateSubaccountsCreateSubaccountPOST(Models.CreateSubaccount body)
        {
            Task<object> t = CreateSubaccountsCreateSubaccountPOSTAsync(body);
        ...
        /// <param name="body">Required parameter: create sub account</param>
        /// <return>Returns the object response from the API call</return>
        public async Task<object> CreateSubaccountsCreateSubaccountPOSTAsync(Models.CreateSubaccount body)
        {
            ...
            _queryBuilder.Append("/subaccounts/createSubaccount");
