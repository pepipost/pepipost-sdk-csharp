...
{
    public partial class SubaccountsUpdateSubaccountController: BaseController
    {
        ...
        /// </summary>
        internal static SubaccountsUpdateSubaccountController Instance
        {
            get
            {
                lock (syncObject)
        ...
        public object CreateSubaccountsUpdateSubaccountPOST(Models.UpdateSubaccount body)
        {
            Task<object> t = CreateSubaccountsUpdateSubaccountPOSTAsync(body);
