...
{
    public partial class SubaccountsController: BaseController
    {
        ...
        /// </summary>
        internal static SubaccountsController Instance
        {
            get
            {
                lock (syncObject)
        ...
        /// </summary>
        /// <param name="body">Required parameter: enable or disable subaccount</param>
        /// <return>Returns the object response from the API call</return>
        public object UpdateSubaccountsPATCH(Models.EnableOrDisableSubacoount body)
        {
            Task<object> t = UpdateSubaccountsPATCHAsync(body);
        ...
        /// <param name="body">Required parameter: enable or disable subaccount</param>
        /// <return>Returns the object response from the API call</return>
        public async Task<object> UpdateSubaccountsPATCHAsync(Models.EnableOrDisableSubacoount body)
        {
            ...
            _queryBuilder.Append("/subaccounts");
